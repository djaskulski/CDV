# -*- coding: utf-8 -*-
"""
Created on Tue Feb 11 11:56:30 2020
...
def swiatlaUliczne(i, j, grid):
    swiatlaUliczne = np.array([[0, 255, 0],
                               [0,255,0],
                               [0,255,0]])
    grid[i:i + 3, j:j + 3] = swiatlaUliczne
...
def latarnia(i, j, grid):
    latarnia = np.array([[255, 255, 0, 0],
                         [255, 0, 0, 0],
                         [0, 0, 0, 255], 
                         [0, 0, 255, 255]])
    grid[i:i + 4, j:j + 4] = latarnia  

def main():
    obraz = macierzLosowa(15)
    blok(0, 0, obraz)
    ul(4, 6, obraz)
    bochenek(0, 6,obraz)
    lodka (0, 12, obraz)
    swiatlaUliczne(4, 12, obraz)
    zaba(4, 0, obraz)
    latarnia (10, 0, obraz)
